...
namespace PolyPerfect
{
    ...
    public class WanderScript : MonoBehaviour
    {
        ...
        public bool moveToPitstop = false;
        ...
        private IEnumerator InitYield()
        {
            ...
            DecideNextState(false,false, true);
        }

        private void DecideNextState(bool wasIdle, bool pitStop, bool firstState = false)
        {
            if (pitStop == true)
            {
                //MovementState()
